...
inline auto MeanRelativeError(InputIt1 begin1, InputIt1 end1, InputIt2 begin2) noexcept -> double
{
...
template<typename T>
inline auto MeanRelativeError(Operon::Span<T const> x, Operon::Span<T const> y) -> double
{
